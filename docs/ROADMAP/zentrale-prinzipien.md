...
| 4 | Autocommand-Gruppen sauber nutzen | ✅ The `VimEnter` autocmd now lives in the named `pickers.nvim` augroup via `lib.nvim.bindings.autocmd` (reload-safe), `once=true`. |
