...
---in matches, with no CursorMoved/TextChanged to hang off of.
---@param prompt_bufnr integer
---@param results_bufnr integer
---@param base_title string
---@param get_picker fun():table|nil
local function start_polling(prompt_bufnr, results_bufnr, base_title, get_picker)
...
function M.attach_mappings(prompt_bufnr)
  ...
  start_polling(prompt_bufnr, picker.results_bufnr, base_title, get_picker)
