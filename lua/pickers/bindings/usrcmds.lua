...
---
--- A user-defined collection (pickers.bindings.collections) gets the same
--- arg-less :{PascalName}Files/Grep/Smart compat commands for free -- see
--- docs/collections.md. Add a `resolve`/`complete` pair like
--- pickers.sources.repos' own if a particular collection also wants a
--- direct-jump-by-name command.
---
